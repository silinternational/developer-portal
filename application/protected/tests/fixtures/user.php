...
return array(
    ...
    'userWithApprovedKeyRequest' => array(
        'user_id'       => 4,
        'email'         => 'userWithApprovedKeyRequest@jaars.net',
    ...
    'userWithDeniedKeyRequest' => array(
        'user_id'       => 5,
        'email'         => 'userWithDeniedKeyRequest@jaars.net',
    ...
    'userWithPendingKeyRequest' => array(
        'user_id'       => 6,
        'email'         => 'userWithPendingKeyRequest@jaars.net',
    ...
    'userWithRevokedKeyRequest' => array(
        'user_id'       => 7,
        'email'         => 'userWithRevokedKeyRequest@jaars.net',
    ...
    'userWithPendingKeyRequestForApiOwnedByUser18' => array(
        'user_id'       => 22,
        'email'         => 'userWithPendingKeyRequestForApiOwnedByUser18@jaars.net',
        'first_name'    => 'With Pending Key Request',
